...
- StarHarbor Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called StarHarbor Lite. It should be a full-viewport asteroid-docking arcade game where the player pilots a small shuttle with keyboard and mouse/touch, dodges drifting asteroids, collects fuel cells, docks at a moving beacon, pauses/resumes, opens settings/help screens, adjusts…
...
- Gameplay - StarHarbor Lite
- Game Settings - StarHarbor Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - StarHarbor Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - StarHarbor Lite
